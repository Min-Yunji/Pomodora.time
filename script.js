...
class Pomodoro {
  ...
  handleMode(event) {
    ...
    if (this.mode == "pomodoro") {
      container.style.backgroundColor="rgba(15, 15, 15)"
      document.body.style.backgroundColor = "rgba(0, 0, 0)";
    } else if (this.mode == "longBreak") {
      container.style.backgroundColor="rgba(0,0,0,0.5)"
      document.body.style.backgroundColor = "rgba(43, 0, 63, 0.99)";
    } else {
      container.style.backgroundColor="rgba(0,0,0,0.2)";
      document.body.style.backgroundColor = "rgba(10, 0, 32, 0.99)";
    }
